...
const relativeTime = __webpack_require__(916);
...
const buildReadme = (prevReadmeContent, data) => {
  ...
  parsedData.activity.forEach(act => {
    let template = [
      "<ul>"," <li>",`   <h3>${act.time} ${plusSVG}${act.plus} ${minusSVG}${act.minus}</h3>`,"     <ul>"
    ];
...
const hasFlag = __webpack_require__(623);
...
module.exports = __webpack_require__(585)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(80);
...
try {
	...
	const supportsColor = __webpack_require__(111);
